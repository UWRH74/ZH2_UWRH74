...
public partial class Cuccmánycontext : DbContext
{
    public Cuccmánycontext()
    {
    }

    public Cuccmánycontext(DbContextOptions<Cuccmánycontext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\UWRH74\\Desktop\\ZH2_UWRH74\\ZH2_UWRH74\\Database1.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C486BB1FFA5");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD8250549A88F");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF0768FC1168C");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A28422123C3");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E2DF358AD4");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CF68F07628");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE204335EAAFBF");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED9676BFE07F5");
